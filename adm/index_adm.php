...
<body>
    ...
    <div id="topo">
        <div class="container"> <!--utilizando container, ele  coloca em uma caixa centralizada no navegador  -->
          ...
          <!--  <div id="conteudo">
                ...
                <div class="row my-3">
                    ...
                    <div class="col-6 bg-light p-3">
                        ...
                        <form enctype="multipart/form-data" action="../VoltaAoMundo-China/mensagens/mensagem-gravar.php" method="POST">
                            <div class="mb-3">
